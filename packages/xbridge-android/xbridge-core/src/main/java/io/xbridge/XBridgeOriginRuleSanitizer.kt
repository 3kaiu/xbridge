...
// 当前仓库内部无任何调用方（flutter_yashi_ai / yashi-h5 亦无引用），
// 保留以兼容可能的外部 JitPack 消费者。计划在下一个大版本移除。
@Deprecated("XBridgeOriginRuleSanitizer 自 v0.1.4 起弃用，计划在下一个大版本移除。仓库内及已知宿主均无调用方。")
/**
